...
export class CaracteristicaComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.caracteristicaService
      ...
      .subscribe(
        (res: HttpResponse<ICaracteristica[]>) => this.paginateCaracteristicas(res.body, res.headers),
  ...
  protected paginateCaracteristicas(data: ICaracteristica[], headers: HttpHeaders) {
