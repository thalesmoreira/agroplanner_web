...
import { PropriedadeComponent } from 'app/entities/propriedade/propriedade.component';
  ...
  describe('Propriedade Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PropriedadeComponent, '')
        .compileComponents();
